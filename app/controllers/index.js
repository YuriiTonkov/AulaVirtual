...
if (Ti.App.Properties.getString('Login')==undefined){
   ...
   window.open({modal:true, modalTransitionStyle: Ti.UI.iPhone.MODAL_TRANSITION_STYLE_FLIP_HORIZONTAL, modalStyle: Ti.UI.iPhone.MODAL_PRESENTATION_FORMSHEET});
    ...
    var lblPass = Titanium.UI.createLabel({color:"#000",text:'Contraseña:',top:130,left:35,width:245,height:'auto',font: {fontSize:"15dp", fontFamily:"Helvetica Neue"}});
    var lblError = Titanium.UI.createLabel({color:"#f00", visible:"false", top:300,left:35,width:"100%",height:'auto',font: {fontSize:"15dp", fontFamily:"Helvetica Neue"}});
    var txtLogin = Titanium.UI.createTextField({top:90,left:35,width:245,borderStyle:Titanium.UI.INPUT_BORDERSTYLE_ROUNDED,font: {fontSize:"15dp", fontFamily:"Helvetica Neue"}});
    var txtPass = Titanium.UI.createTextField({top:160,left:35,width:245, passwordMask:"true", borderStyle:Titanium.UI.INPUT_BORDERSTYLE_ROUNDED,font: {fontSize:"15dp", fontFamily:"Helvetica Neue"}});
    var lblAyuda = Titanium.UI.createLabel({color:"#000",text:'Ayuda activa:',top:220,left:65,width:100,height:'auto',font: {fontSize:"15dp", fontFamily:"Helvetica Neue"}});
