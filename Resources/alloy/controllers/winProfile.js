function Controller() {
    ...
    var __alloyId222 = [];
    __alloyId222.push($.__views.__alloyId221);
    ...
    $.__views.__alloyId221.add($.__views.txtNombre);
    $.__views.__alloyId224 = Ti.UI.createTableViewRow({
        backgroundColor: "white",
        height: "40dp",
        id: "__alloyId224"
    });
    __alloyId222.push($.__views.__alloyId224);
    ...
    $.__views.__alloyId224.add($.__views.txtApellido1);
    $.__views.__alloyId226 = Ti.UI.createTableViewRow({
        backgroundColor: "white",
        height: "40dp",
        id: "__alloyId226"
    });
    __alloyId222.push($.__views.__alloyId226);
    ...
    $.__views.__alloyId226.add($.__views.txtApellido2);
    $.__views.__alloyId228 = Ti.UI.createTableViewRow({
        backgroundColor: "white",
        height: "40dp",
        id: "__alloyId228"
    });
    __alloyId222.push($.__views.__alloyId228);
    ...
    $.__views.__alloyId228.add($.__views.txtDireccion);
    $.__views.__alloyId230 = Ti.UI.createTableViewRow({
        backgroundColor: "white",
        height: "40dp",
        id: "__alloyId230"
    });
    __alloyId222.push($.__views.__alloyId230);
    ...
    $.__views.__alloyId230.add($.__views.txtCodPostal);
    $.__views.__alloyId232 = Ti.UI.createTableViewRow({
        backgroundColor: "white",
        height: "40dp",
        id: "__alloyId232"
    });
    __alloyId222.push($.__views.__alloyId232);
    ...
    $.__views.__alloyId232.add($.__views.txtTelefono);
    $.__views.__alloyId234 = Ti.UI.createTableViewRow({
        backgroundColor: "white",
        height: "40dp",
        id: "__alloyId234"
    });
    __alloyId222.push($.__views.__alloyId234);
    ...
    $.__views.__alloyId234.add($.__views.txtEmail);
    $.__views.__alloyId236 = Ti.UI.createTableViewRow({
        backgroundColor: "white",
        height: "40dp",
        id: "__alloyId236"
    });
    __alloyId222.push($.__views.__alloyId236);
    ...
    $.__views.__alloyId236.add($.__views.chkAyuda);
