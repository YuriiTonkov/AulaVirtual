function Controller() {
    function __alloyId116() {
        ...
        for (var i = 0; len > i; i++) {
            ...
            __alloyId113.__transform = NombreClase(__alloyId113);
            var __alloyId114 = Alloy.createController("ClaseRow", {
                $model: __alloyId113
            });
    ...
    var __alloyId115 = Alloy.Collections["VW_Clases_Favoritas"] || VW_Clases_Favoritas;
