function Controller() {
    function __alloyId150() {
        ...
        for (var i = 0; len > i; i++) {
            ...
            __alloyId147.__transform = NombreClase(__alloyId147);
            var __alloyId148 = Alloy.createController("ClaseRow", {
                $model: __alloyId147
            });
    ...
    var __alloyId149 = Alloy.Collections["VW_Clases_Favoritas"] || VW_Clases_Favoritas;
