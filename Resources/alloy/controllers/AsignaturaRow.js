function Controller() {
    ...
    $.__views.tblAsignaturaRow = Ti.UI.createTableViewRow({
        editable: "true",
        data: "undefined" != typeof $model.__transform["IdAsignaturaAlumno"] ? $model.__transform["IdAsignaturaAlumno"] : $model.get("IdAsignaturaAlumno"),
        hasChild: "true",
        id: "tblAsignaturaRow"
    });
    ...
    $.__views.lblAsignatura = Ti.UI.createLabel({
        ...
        textid: "undefined" != typeof $model.__transform["IdAsignaturaAlumno"] ? $model.__transform["IdAsignaturaAlumno"] : $model.get("IdAsignaturaAlumno")
    });
