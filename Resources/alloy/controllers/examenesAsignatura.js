function Controller() {
    function __alloyId150() {
        ...
        var rows = [];
        for (var i = 0; len > i; i++) {
            var __alloyId146 = models[i];
            __alloyId146.__transform = {};
            var __alloyId147 = Ti.UI.createTableViewRow({
                backgroundColor: "white",
                height: "40dp",
                editable: "true",
                data: "undefined" != typeof __alloyId146.__transform["IdExamen"] ? __alloyId146.__transform["IdExamen"] : __alloyId146.get("IdExamen")
            });
            rows.push(__alloyId147);
            var __alloyId148 = Ti.UI.createLabel({
                ...
                text: "undefined" != typeof __alloyId146.__transform["FechaExamen"] ? __alloyId146.__transform["FechaExamen"] : __alloyId146.get("FechaExamen"),
                textid: "undefined" != typeof __alloyId146.__transform["IdExamen"] ? __alloyId146.__transform["IdExamen"] : __alloyId146.get("IdExamen")
            });
    ...
    $.__views.examenesAsignaturas.add($.__views.__alloyId145);
    ...
    var __alloyId149 = Alloy.Collections["VW_Examen_Alumno"] || VW_Examen_Alumno;
