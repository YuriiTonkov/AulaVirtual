function Controller() {
    function __alloyId160(e) {
        ...
        var rows = [];
        for (var i = 0; len > i; i++) {
            var __alloyId156 = models[i];
            __alloyId156.__transform = nombrecompleto(__alloyId156);
            var __alloyId157 = Ti.UI.createTableViewRow({
                backgroundColor: "white",
                height: "40dp",
                editable: "true",
                data: "undefined" != typeof __alloyId156.__transform["IdAlumno"] ? __alloyId156.__transform["IdAlumno"] : __alloyId156.get("IdAlumno")
            });
            rows.push(__alloyId157);
            var __alloyId158 = Ti.UI.createLabel({
                ...
                text: "undefined" != typeof __alloyId156.__transform["nombrecompleto"] ? __alloyId156.__transform["nombrecompleto"] : __alloyId156.get("nombrecompleto"),
                textid: "undefined" != typeof __alloyId156.__transform["IdAlumno"] ? __alloyId156.__transform["IdAlumno"] : __alloyId156.get("IdAlumno")
            });
    ...
    $.__views.addAlumno.add($.__views.__alloyId155);
    ...
    var __alloyId159 = Alloy.Collections["VW_Asignatura_Alumno_Left"] || VW_Asignatura_Alumno_Left;
    __alloyId159.on("fetch destroy change add remove reset", __alloyId160);
    ...
    exports.destroy = function() {
        __alloyId159.off("fetch destroy change add remove reset", __alloyId160);
    };
    _.extend($, $.__views);
