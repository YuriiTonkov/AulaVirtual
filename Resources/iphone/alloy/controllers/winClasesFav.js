function Controller() {
    function __alloyId214(e) {
        ...
        for (var i = 0; len > i; i++) {
            ...
            __alloyId210.__transform = NombreClase(__alloyId210);
            var __alloyId212 = Alloy.createController("ClaseRow", {
                $model: __alloyId210,
    ...
    var __alloyId213 = Alloy.Collections["VW_Clases_Favoritas"] || VW_Clases_Favoritas;
