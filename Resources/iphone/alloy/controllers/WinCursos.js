function Controller() {
    function __alloyId120(e) {
        ...
        for (var i = 0; len > i; i++) {
            ...
            var __alloyId116 = Alloy.createController("CursoRow", {
                $model: __alloyId114,
                __parentSymbol: __parentSymbol
            });
            rows.push(__alloyId116.getViewEx({
                recurse: true
            }));
        }
    ...
    $.__views.TablaCursos = Ti.UI.createTableView({
        ...
        top: "0dp",
        headerView: $.__views.__alloyId113,
        footerView: $.__views.__alloyId118,
        id: "TablaCursos"
    });
    $.__views.WinCursos.add($.__views.TablaCursos);
    var __alloyId119 = Alloy.Collections["Curso"] || Curso;
